...
!(function (e) {
    ...
    (t.prototype = {
        ...
        showSiblingsEnd: function (e) {
            var t = e.data.node;
            e.data.visibleNodes.removeClass("sliding"), this.isInAction(t) && (this.switchHorizontalArrow(t), t.children(".topEdge").removeClass("oci-minus-circle").addClass("oci-plus-circle"));
        },
        ...
        switchVerticalArrow: function (e) {
            e.toggleClass("oci-minus-circle").toggleClass("oci-plus-circle");
        },
        ...
        nodeEnterLeaveHandler: function (e) {
            ...
            if (t.closest(".nodes.vertical").length) {
                ...
                "mouseenter" === e.type
                    ? (s.length && ((i = this.getNodeState(t, "parent").visible), s.toggleClass("oci-minus-circle", !i).toggleClass("oci-plus-circle", i)),
                      o.length && ((i = this.getNodeState(t, "children").visible), o.toggleClass("oci-plus-circle", !i).toggleClass("oci-minus-circle", i)),
                      a.length && this.switchHorizontalArrow(t))
                    : t.children(".edge").removeClass("oci-minus-circle oci-plus-circle oci-chevron-right oci-chevron-left");
            }
        },
        ...
        createNode: function (i) {
            ...
            n.nodeTemplate ? t.append(n.nodeTemplate(i)) : t.append('<img src="'+i[n.nodeImage]+'">').append('<div class="title">' + i[n.nodeTitle] + "</div>").append(void 0 !== n.nodeContent ? '<div class="content">' + (i[n.nodeContent] || "") + "</div>" : "");
            var s = p.extend({}, i);
        ...
        addSiblings: function (e, t) {
            this.buildSiblingNode(e.closest(".hierarchy"), t),
                ...
                this.isInAction(e) && (this.switchHorizontalArrow(e), e.children(".topEdge").removeClass("oci-minus-circle").addClass("oci-plus-circle"));
        },
        removeNodes: function (e) {
            var t = e.closest(".hierarchy").parent();
            t.parent().is(".hierarchy")
                ? this.getNodeState(e, "siblings").exist
                    ? (e.closest(".hierarchy").remove(), 1 === t.children().length && t.find(".node:first .horizontalEdge").remove())
                    : t.siblings(".node").find(".bottomEdge").remove().end().end().remove()

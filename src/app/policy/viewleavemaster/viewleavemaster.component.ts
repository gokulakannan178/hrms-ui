...
@Component({
  selector: 'app-viewleavemaster',
  templateUrl: './viewleavemaster.component.html',
  styleUrls: ['./viewleavemaster.component.css']
})
export class ViewleavemasterComponent implements OnInit {
